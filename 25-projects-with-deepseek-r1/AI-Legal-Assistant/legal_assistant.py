...
interface = gr.Interface(
    ...
    inputs=[
        gr.Radio(["Rental Agreement", "Employment Contract", "Business Partnership Agreemnt", "NDA"], label="Document Type"),
    ...
    description="Select a document type, enter party names, and generate a profissional legal contract."
)
